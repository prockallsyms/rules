...
-- security bits (SECURE_SYMLINKS=0x40, SECURE_NODOTDOT=0x80) → path traversal / zip-slip. (CWE-22/CWE-59)
scopes = {
...
local function unsafe(op)
  ...
  return missing(0x40) or missing(0x80)   -- missing SECURE_SYMLINKS or SECURE_NODOTDOT
end
